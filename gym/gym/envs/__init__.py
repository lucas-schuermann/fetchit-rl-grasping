...
for reward_type in ['sparse', 'dense']:
    ...
    # LVS
    register(
        id='LVSFetchPickAndPlace{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:LVSFetchPickAndPlaceEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    register(
        id='LVSRotatedFetchPickAndPlace{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:LVSRotatedFetchPickAndPlaceEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

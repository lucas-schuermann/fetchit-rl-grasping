...
DEFAULT_PARAMS = {
    ...
    'batch_size':
    1024,  # per mpi thread, measured in transitions and reduced to even multiple of chunk_length.
    'n_test_rollouts':
    ...
    'noise_eps':
    0.1,  # std of gaussian noise added to not-completely-random actions as a percentage of max_u
    # HER
    ...
    'bc_loss':
    1,  # whether or not to use the behavior cloning loss as an auxilliary loss
    'q_filter':
    1,  # whether or not a Q value filter should be used on the Actor outputs
